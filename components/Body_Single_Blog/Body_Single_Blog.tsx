...
import MainPoint from "../Main_Point/Main_Point";
...
function BodySingleBlog() {
  return (
    <>
      ...
      <Image src={banner} alt="" className={styles.single__blog__banner1} />
      ...
      <Image src={banner} alt="" className={styles.single__blog__banner1} width={100} height={100} />
